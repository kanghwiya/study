...
CREATE TABLE orders (
	...
	,CONSTRAINT fk_orders_product_no FOREIGN KEY(product_no)
		REFERENCES ordered(product_no) ON DELETE NO ACTION
);
-- alter로 fk 넣는 방법 있음
...
-- DROP TABLE members, points, orders, ordered;



INSERT INTO members(id, mem_name, addr, age)
VALUES ('admin', '나몰빼미', 'sun&moon', 1);
